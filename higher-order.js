...
//Code Here
let totalPopulation = populations.reduce((total, a) => total + a);
...
let bobsTotal = purchases.filter(e => e["owner"] === "Bob" ? e["price"] : null).map(purchase => purchase["price"]).reduce((total, val) => total + val);
