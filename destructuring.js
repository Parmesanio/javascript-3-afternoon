...
const ingredients = (obj => {
  ...
  nutrientArray.push(carb, fat, protein);
...
const largeNumbers = ({first, second, third}) => first < second && first < third ? first: second < third && second < first ? second : third < first && third < second ? third : null;
